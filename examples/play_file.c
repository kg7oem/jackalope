...
int main(const int argc_in, const char ** argv_in)
{
    ...
    struct jackalope_object_t * input_file = jackalope_graph_make_node(graph, input_file_args);
    ...
    struct jackalope_object_t * system_audio = jackalope_graph_make_node(graph, system_audio_args);
    ...
    struct jackalope_object_t * left_tube = jackalope_graph_make_node(graph, left_tube_args);
    ...
    struct jackalope_object_t * right_tube = jackalope_graph_make_node(graph, right_tube_args);
